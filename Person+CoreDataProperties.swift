...
extension Person {
    ...
    public func getArray(FilterType:String,FilterString:String,SortType:String,WineType:String)->[Item] {
        ...
        if FilterString == "" {
            ...
            for i in 0...collection.count-1 {
                if (collection[i].wrappedName.prefix(searchStringLength) == FilterString && (WineType == collection[i].wrappedType || WineType == "Any")) {
                    Arr.append(collection[i])
                }
            }
        }
            ...
            for i in 0...collection.count-1 {
                if (collection[i].wrappedDomain.prefix(searchStringLength) == FilterString && (WineType == collection[i].wrappedType || WineType == "Any")) {
                    Arr.append(collection[i])
                }
            }
            ...
            for i in 0...collection.count-1 {
                if (collection[i].wrappedCreator.prefix(searchStringLength) == FilterString && (WineType == collection[i].wrappedType || WineType == "Any")) {
                    Arr.append(collection[i])
                }
            }
